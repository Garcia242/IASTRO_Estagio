...
# create a model instance
model4 = CmdStanModel(
    stan_file="Meu_Codigo/Baryonic_Acoustic_Oscilators/Model/BAO.stan",                         # Stan model file location
    cpp_options={
...
fit4 = model4.sample(
    ...
    data="Meu_Codigo/Baryonic_Acoustic_Oscilators/Data/bao.json",                                # the location of the data file
...
samples4 = [fit4.stan_variable("H0"), fit4.stan_variable("Om")]
mcsamples4 = MCSamples(samples=samples1, names=["H0", "Om"], labels=["H0", "Om"])
g = plots.get_subplot_plotter()
g.triangle_plot(mcsamples4, filled=True)
...
g = plots.get_subplot_plotter()
g.triangle_plot([mcsamples1 ,mcsamples2, mcsamples4], filled=True)
