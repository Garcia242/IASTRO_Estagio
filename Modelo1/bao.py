...
model = CmdStanModel(
    stan_file="Modelo1/Model/newbao.stan",                         # Stan model file location
    cpp_options={
...
fit = model.sample(
    data="Modelo1/Data/bao.json",                                # the location of the data file
    #output_dir="output1/bao",       # save output to specified folder
