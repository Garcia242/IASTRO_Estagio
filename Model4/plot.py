...
folders = ["output4/cc", "output4/snia", "output4/bao", "output4/together"]
legends = ["CC", "SnIa", "BAO", "Combined"]

# specify the parameters that were constrained in each model
paramsperfolder = [["H0", "Om", "lambda"], ["Om", "lambda"],["H0", "Om", "lambda"], ["H0", "Om", "lambda"]]
labelsperfolder = [["H0", "\\Omega_m", "lambda"], ["H0", "\\Omega_m", "lambda"], ["H0", "\\Omega_m", "lambda"], ["H0", "\\Omega_m", "lambda"]]
