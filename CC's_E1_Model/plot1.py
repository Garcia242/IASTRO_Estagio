...
folders = ["output_mod1/SNIa", "output_mod1/cosmic", "output_mod1/Bao", "output_mod1/Mod_juntos"]
legends = ["cosmic", "SNIa", "Bao", "Mod1"]

# specify the parameters that were constrained in each model
paramsperfolder = [["H0", "Om", "zeta"],["H0", "Om", "zeta"], ["H0", "Om", "zeta"],["H0", "Om", "zeta"]]
labelsperfolder = [["H0", "Om", "zeta"],["H0", "Om", "zeta"], ["H0", "Om", "zeta"],["H0", "Om", "zeta"]]
